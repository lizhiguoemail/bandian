...
//                dbConfig.setIdType(IdType.ASSIGN_UUID);
        ...
        focList.add(new FileOutConfig(templatePath) {
            ...
            public String outputFile(TableInfo tableInfo) {
                ...
                return projectPath + "/" + tableInfo.getEntityName() + "Mapper" + StringPool.DOT_XML;
...
//                        + "/" + tableInfo.getEntityName() + "Mapper" + StringPool.DOT_XML;
        ...
        */
        ...
        templateConfig.setXml("templates/angular/angular");
...
//lzg end
        ...
        // 公共父类
        strategy.setSuperControllerClass(com.lhsz.bandian.controller.BaseController.class);
