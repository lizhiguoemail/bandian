...
public class JuryUserDTO extends BaseDTO {

    public JuryUserDTO(){}
    public JuryUserDTO(User user){
        CopyUtils.copyProperties(user,this);
    ...
    private String juryDeptId;
    private String juryDeptName;
